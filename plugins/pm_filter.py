...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ʜᴇʏ ᴅᴜᴅᴇ 😍 ᴊᴀʜᴀ ᴀᴘᴘ ᴍᴏᴠɪᴇꜱ ꜱᴇᴀʀᴄʜ ɴʜɪ ᴋʀ ꜱᴀᴋᴛᴇ ʜᴏ. ɢʀᴏᴜᴘ ᴍᴇɪ ᴊᴀᴀᴋʀ ᴍᴏᴠɪᴇꜱ ᴏʀ ᴡᴇʙꜱᴇʀɪᴇꜱ ɴᴀᴍᴇ ᴛʏᴘᴇ ᴋʀᴏ 
👉 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ : <a href='https://t.me/hb_moive/'>ᴛᴀᴘ ʜᴇʀᴇ</a></b>")
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url="https://t.me/naruto_update_ch")
                            ],[
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴍᴏᴠɪᴇ Gʀᴏᴜᴘ', url='https://t.me/hb_moive')
                ],[
                    InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url='https://t.me/naruto_update_ch')
                  ]]
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/Hariomsingh31u")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
